            <?php
                ...
                elseif(!empty($_POST['include-uppercase']) AND !empty($_POST['include-lowercase']) AND empty($_POST['include-numbers']) AND empty($_POST['include-symbols']))
                {
                    ...
                    //permet de completer les six autre caractères manquants en tirant au hasard 6 caractères dans la chaine $characters
                    for($i=0; $i<6; $i++)
                    {
                ...
                elseif(!empty($_POST['include-numbers']) AND !empty($_POST['include-symbols']) AND empty($_POST['include-uppercase']) AND empty($_POST['include-lowercase']))
                {
                    ...
                    //permet de completer les qsix autre caractères manquants en tirant au hasard 6 caractères dans la chaine $characters
                    for($i=0; $i<6; $i++)
                    {
                        $password .= get_characters($characters);
                    }
                ...
                elseif(!empty($_POST['include-uppercase']) AND !empty($_POST['include-lowercase']) AND !empty($_POST['include-numbers']) AND empty($_POST['include-symbols']))
                {
                    ...
                    //permet de completer les cinq autre caractères manquants en tirant au hasard 5 caractères dans la chaine $characters
                    for($i=0; $i<5; $i++)
                    {
                        $password .= get_characters($characters);
                    }
                ...
                elseif(!empty($_POST['include-uppercase']) AND !empty($_POST['include-lowercase']) AND !empty($_POST['include-symbols']) AND empty($_POST['include-numbers']))
                {
                    ...
                    //permet de completer les cinq autres caractères manquants en tirant au hasard 5 caractères dans la chaine $characters
                    for($i=0; $i<5; $i++)
                    {
                        $password .= get_characters($characters);
                    }
                ...
                elseif(!empty($_POST['include-symbols']) AND !empty($_POST['include-numbers']) AND !empty($_POST['include-uppercase']) AND !empty($_POST['include-lowercase']))
                {
                    ...
                    $numbers = '0123456789';
                    $uppercaseCharacters = 'ABCDEFGHIJKLMNOPQRSTVWXYZ';
                    $characters = $lowercaseCharacters.$numbers.$specialCharacters.$uppercaseCharacters;
                    $password = '';
                    ...
                    //permet de completer les quatres autres caractères manquants en tirant au hasard 4 caractères dans la chaine $characters
                    for($i=0; $i<4; $i++)
                    {
                        $password .= get_characters($characters);
                    }

            <?php
                ...
                elseif(!empty($_POST['include-uppercase']) AND !empty($_POST['include-lowercase']) AND empty($_POST['include-numbers']) AND empty($_POST['include-symbols']))
                {
                    ...
                    //permet de completer les quatres autre caractères manquants en tirant au hasard 4 caractères dans la chaine $characters
                    for($i=0; $i<4; $i++)
                    {
                ...
                elseif(!empty($_POST['include-uppercase']) AND !empty($_POST['include-lowercase']) AND !empty($_POST['include-numbers']) AND empty($_POST['include-symbols']))
                {
                    ...
                    //permet de completer les trois autre caractères manquants en tirant au hasard 3 caractères dans la chaine $characters
                    for($i=0; $i<3; $i++)
                    {
                        $password .= get_characters($characters);
                    }
                ...
                elseif(!empty($_POST['include-uppercase']) AND !empty($_POST['include-lowercase']) AND !empty($_POST['include-symbols']) AND empty($_POST['include-numbers']))
                {
                    ...
                    //permet de completer les trois autres caractères manquants en tirant au hasard 3 caractères dans la chaine $characters
                    for($i=0; $i<3; $i++)
                    {
                        $password .= get_characters($characters);
                    }
                ...
                elseif(!empty($_POST['include-symbols']) AND !empty($_POST['include-numbers']) AND !empty($_POST['include-uppercase']) AND !empty($_POST['include-lowercase']))
                {
                    ...
                    //permet de completer les deux autres caractères manquants en tirant au hasard 2 caractères dans la chaine $characters
                    for($i=0; $i<2; $i++)
                    {
                        $password .= get_characters($characters);
                    }
